...
exports.getCartPage = async (req, res) => {
    const data = await frontSerivice.getCartPageData(req.userToken,req.user.username)
...
exports.saveCart = async (req, res) => {
    ...
    return res.status(200).send(await cartService.saveProductInCart(req.user.username,idProduct,cant))
}
...
exports.deleteProductCart = async (req, res) => {
    ...
    return res.status(200).send(await cartService.deteProductInCart(req.user.username,idProduct,cant))
}
